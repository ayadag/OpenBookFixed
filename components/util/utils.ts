...
export async function sendTx(
    ...
    export async function buildAndSendTx(innerSimpleV0Transaction: InnerSimpleV0Transaction[], connection: web3.Connection, wallet: Keypair| Signer, options?: SendOptions) {
